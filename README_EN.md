...
| [orchestrator/](orchestrator/README.md) | **Thin orchestrator** — first mechanical-layer step: stage gates, circuit-breaker counting, and exit-code collection enforced by script (`gate`/`test`/`reset`), turning "real runs, max 5 rounds" from prompt promises into physical constraints |
